...
#     return resnet
    ...
    resnet.load_state_dict(state_dict)
    return resnet
  if model_type=='resnet50_l2_eps1' or model_type=='resnet50_l2_eps0.01' or model_type=='resnet50_l2_eps0.03' or model_type=='resnet50_l2_eps0.5' or model_type=='resnet50_l2_eps0.25' or model_type=='resnet50_l2_eps3' or model_type=='resnet50_l2_eps5' or model_type=='resnet50_l2_eps0.1' or model_type=='resnet50_l2_eps0.05' :
    resnet=models.resnet50(pretrained=False)
    ds = ImageNet('/tmp')
...
def get_acc(loader):
    ...
    np.save(f'/content/gdrive/MyDrive/model_OOD_acc/imagenet-r/{sys.argv[1]}.npy',100*acc)
    return acc
